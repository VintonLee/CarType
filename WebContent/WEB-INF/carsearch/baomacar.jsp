...
<div class="age">
     	    ...
     	    <a class="select" name="b_link" para="custom" cl="" href="search.do?car=qitacar">其他</a>
     			...
     			价格：
     		<a name="b_link" para="custom" cl="" href="search.do?car=baomacar&&low=0&&high=99">不限</a>
     		<a name="b_link" para="custom" cl="" href="search.do?car=baomacar&&low=0&&high=10">10万元以内</a>
     		<a name="b_link" para="custom" cl="" href="search.do?car=baomacar&&low=10&&high=20">10-20万元</a>
     		<a name="b_link" para="custom" cl="" href="search.do?car=baomacar&&low=20&&high=99">20万元以上</a>
	...
	<tbody id="table2">
		...
		<c:forEach items="${baoma}" var="o" varStatus="status">
				 <tr>
					<td>${o.carname}</td>
					<td>${o.carinfo}</td>
					<td>${o.carlc}</td>
